 ...
 */
export type FeaturedArticlesGrid2Props =
  SliceComponentProps<Content.FeaturedArticlesGrid2Slice>;

/**
 * Component for "FeaturedArticlesGrid" Slices.
 */
const FeaturedArticlesGrid2: FC<FeaturedArticlesGrid2Props> = ({ slice }) => {
  return (
    <section
          ...
          {slice.primary.articles.map((item, index) => (
            ...
            >
              ...
              <div className="flex flex-col p-5 md:p-6 flex-1">
                ...
                {/* Article Summary */}
                {item.summary && (
                  <div className="text-sm md:text-base xl:text-[16px] xl:-mx-6 xl:font-medium text-gray-600 leading-relaxed line-clamp-3 flex-1">
...
export default FeaturedArticlesGrid2;
